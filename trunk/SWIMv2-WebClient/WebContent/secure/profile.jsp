...
<div class="contentleft">
      ...
      <%if(usr!=null){
    	  ...
    	  if(usr.getSex()!=null){
        	  out.write("<td class=\"formLabel\">"+usr.getSex()+"</td>");
        	  } else {
    	  ...
    	  if(usr.getAge()!=null){
        	  out.write("<td class=\"formLabel\">"+usr.getAge()+"</td>");
        	  } else {
        		  out.write("<td class=\"formLabel\">Non specificata.</td>");
        	  }
    	  out.write("</tr>");
    	  ...
    	  if(usr.getCity()!=null){
        	  out.write("<td class=\"formLabel\">"+usr.getCity()+"</td>");
        	  } else {
        		  out.write("<td class=\"formLabel\">Non specificata.</td>");
        	  }
    	  out.write("</tr>");
    	  ...
    	  out.write("<td class=\"formLabel\">"+usr.getOccupation()+"</td>");
    	  } else {
    		  out.write("<td class=\"formLabel\">Non specificata.</td>");
    	  }
    	  out.write("</tr>");
    	  ...
    	  out.write("<h1>Utente richiesto non valido.</h1>");
